...
function updateS1(){
  t3.html("Infection Probability = " + sSlider.value() + "%")
  probInfectRate = sSlider.value();
}

function updateS2(){
  t4.html("Contagious Period = " + dSlider.value())
  infectPeriod[0] = dSlider.value() - 100;
  infectPeriod[1] = dSlider.value() + 100;
}
